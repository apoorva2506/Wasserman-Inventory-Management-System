...
<body>
    <div>
        ...
        echo "Serial Number: ".$_SESSION['snum'];
        $check_sno= $_SESSION['snum'];
        //echo $check_sno;
        ?>
        <br>
        <p>Please enter the details below to checkout.</p><br>
        ...
        <input type="submit" name="success" value="checkout">
        </form>
        </html>
        ...
        {
            $sql_ins = "INSERT INTO check_out (name, borrow_date, return_date,serial_no)
            VALUES ('".$_POST["staff_name"]."','".$_POST["borrow_date"]."','".$_POST["return_date"]."','".$_SESSION['snum']."')";
            $res1 = $conn->query($sql_ins);

            echo "<script>alert('Checked out successfully');
