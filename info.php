    ...
    <div>
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
              //  echo "Example-". "<br>"."sno: " . $row["serial_no"]."<br>"."item_name: " . $row["item_name"]. "<br>". "ip_add: " . $row["ip_add"]. "<br>"."mac_add: " . $row["mac_add"]. "<br>"."location: " . $row["location"]. "<br>";


                echo "Serial Number :{$row['serial_no']}  <br> <br>".
                 "Item Name : {$row['item_name']} <br><br>".
                 "IP Address : {$row['ip_add']} <br><br> ".
                 "MAC Address : {$row['mac_add']} <br><br> ".
                 "Location : {$row['location']} <br><br> ".
                 "Staff : {$row['staff']} <br><br>".
                 "Category : {$row['category']} <br><br> ".
                 "Manufacturer : {$row['Manufacturer']} <br><br> ".
                 ...
                 else if($row['availability']=="In-Use" OR $row['availability']=="") { ?>
          ...
          echo "No products match this serial number.";
      }
       ?><br>

       <br><br>
       Try another device. Go Back:
       <br><br>
