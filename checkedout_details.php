...
<body>
    <div>
        ...
        <div id="wrapper">
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <li class="active"><a href="checkedout_details.php"><i class="fa fa-database fa-fw">
        ...
        echo "<b>Following devices are checked out:</b>";
 ...
 $(document).ready(function(){  
      $('#create_excel').click(function(){  
           var excel_data = $('#checkout_table').html();  
