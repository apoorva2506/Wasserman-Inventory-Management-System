...
<body>
    <div>
        ...
        <div id="wrapper">
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <li class="active"><a href="survey_disp.php"><i class="fa fa-th-list fa-fw">
        ...
        $sql = "select s.serial_no, name, stimestamp, s.category, s.location, s.score from stock s join audit a on s.serial_no=a.serial_no";
