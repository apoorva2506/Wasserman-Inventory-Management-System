...
<body>
    <div>
        ...
        <div id="wrapper">
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <li class="active"><a href="survey.php"><i class="fa fa-gift fa-fw">
        ...
        <p>Please enter the audit details below :</p><br>

        <form action="survey.php" method="post">
        <label>  Device's serial number: </label> <input type="text" name="sno" required><br><br>
          <label>Enter your Name : </label><input type="text" name="survey_name"><br><br>
         <label>Co-Signer : </label><input type="text" name="cosigner" required><br><br>

        <label>  Category :</label>
        <?php
        $sql1 = "SELECT DISTINCT(category) FROM stock group by category";
      ...
      echo "</select><br><br>";
        ...
        <?php
        $sql2 = "SELECT DISTINCT(location) FROM stock group by location";
      ...
      echo "</select><br><br>";
        ...
        <br><br>
        <label>  Additional Comments :</label><input type="text" name="desc"><br><br>

        <form action="surv_success.php" method="post">
          <input type="submit" name="surv_success" value="Done">
          </form>
          </html>

          <?php
            if(isset($_POST['surv_success']))
          {
              $sql_ins = "INSERT INTO audit (serial_no, name, stimestamp, cosigner,category,location,scale,status)
              VALUES ('".$_POST["sno"]."','".$_POST["survey_name"]."',now(),'".$_POST["cosigner"]."','".$_POST["category"]."','".$_POST["location"]."','".$_POST["scale"]."','".$_POST['desc']."')";
              $res1 = $conn->query($sql_ins);

              echo '<script language="javascript">';
              echo 'alert("Submitted successfully"); location.href="survey.php"';
              echo '</script>';
          }
          ?>
