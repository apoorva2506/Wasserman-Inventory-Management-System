...
<body>
    <div>
        ...
        $_SESSION['orig_sno']=htmlspecialchars($_GET["serial_no1"]);
        //echo $_SESSION['orig_sno'];
        ?>

        <form action="abc.php" method="post">
        <label>Device's serial number: </label><input type="text" name="ser_no" value="<?php echo htmlspecialchars($_GET["serial_no1"]); ?>" required><br><br>
        <label>Item Description: </label><input type="text" name="descr" value="<?php echo htmlspecialchars($_GET["item_name"]); ?>"><br><br>
        <label>IP Address: </label><input type="text" name="ip_add" value="<?php echo htmlspecialchars($_GET["ip_add"]); ?>"><br><br>
        <label>Mac Address: </label><input type="text" name="mac_add" value="<?php echo htmlspecialchars($_GET["mac_add"]); ?>"><br><br>
        <label>Location: </label><input type="text" name="location" value="<?php echo htmlspecialchars($_GET["location"]); ?>"><br><br>
        <label>Room: </label><input type="text" name="room" value="<?php echo htmlspecialchars($_GET["room"]); ?>"><br><br>
        <label>Staff: </label><input type="text" name="staff" value="<?php echo htmlspecialchars($_GET["staff"]); ?>"><br><br>
        <label>Category: </label><input type="text" name="category" value="<?php echo htmlspecialchars($_GET["category"]); ?>"><br><br>
        <label>Manufacturer: </label><input type="text" name="manufacturer" value="<?php echo htmlspecialchars($_GET["manufacturer"]); ?>"><br><br>
        <label>availability: </label><input type="text" name="availability" value="<?php echo htmlspecialchars($_GET["availability"]); ?>"><br><br>
        <label>Score: </label><input type="text" name="score" value="<?php echo htmlspecialchars($_GET["score"]); ?>"><br><br>

        <input type="submit" name="upd_success" value="Update">
      </form>

      <?php
       if(isset($_POST['upd_success']))
      {
        //$temp=$_SESSION['origserial'];
        //$_SESSION['temp']=htmlspecialchars($_GET["serial_no1"]);
