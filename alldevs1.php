...
<body>
    <div>
        ...
        <div id="header-topbar-option-demo" class="page-header-topbar">
            ...
            <div class="topbar-main">
                ...
                <div class="news-update-box hidden-xs"><span class="text-uppercase mrm pull-left text-white" style="align: center;"> Wasserman Inventory Management System</span>
                </div>
        ...
        <div id="wrapper">
            ...
            <div class="sidebar-collapse menu-scroll">
                <ul id="side-menu" class="nav">
                    ...
                    <li class="active"><a href="audselect.php"><i class="fa fa-edit fa-fw">
                    ...
                    <li><a href="logout.php"><i class="fa fa-send-o fa-fw">
                        <div class="icon-bg bg-green"></div>
            ...
            <div id="page-wrapper">
               ...
               <!-- <div id="title-breadcrumb-option-demo" class="page-title-breadcrumb">
                ...
                <div class="page-content">
                    <div id="tab-general">
                        <form action="alldevs.php" method="post">
          ...
          $quer = "SELECT DISTINCT(location) from stock group by location ASC";
          $locresult= $conn->query($quer);
      ...
      Audited: <select id="audfilters" name="audfilters">
       ...
       Location: <select id="locationfilter" name="locationfilter">
        <option value="none">--All--</option>
        <?php
      ...
      <button name="create_excel" id="create_excel" class="btn btn-success">Export Excel File</button>  
       <script>  
             $(document).ready(function(){  
                  $('#create_excel').click(function(){  
                       var excel_data = $('#alldevices').html();  
  ...
  if( $selected_filter== "none" or $selected_filter== "") {
    ...
    if ($selected_auditfilter=="none" or $selected_auditfilter== "") {
      ...
      if ($locationfilter=="none" or $locationfilter =="") 
      {
        $sql1 = "SELECT * FROM stock";
      }
      else
      {
        $sql1 = "SELECT * FROM stock where location = '$locationfilter'";
      }
      ...
      if ($locationfilter=="none" or $locationfilter =="") 
      {
        ...
        $sql1 = "SELECT * FROM stock where audit='$selected_auditfilter'";
      }
      else
      {
          $sql1 = "SELECT * FROM stock where location = '$locationfilter' and audit='$selected_auditfilter'";
      }
    ...
    if ($selected_auditfilter=="none" or $selected_auditfilter== "") {
      ...
      if ($locationfilter=="none" or $locationfilter =="") 
      {
        $sql1 = "SELECT * FROM stock where category='$selected_filter'";
      }
      else
      {
        $sql1 = "SELECT * FROM stock where location = '$locationfilter' and category='$selected_filter'";
      }
      ...
      if ($locationfilter=="none" or $locationfilter =="") 
      {
        ...
        $sql1 = "SELECT * FROM stock where audit='$selected_auditfilter' and  category='$selected_filter'";
      }
      else
      {
          $sql1 = "SELECT * FROM stock where location = '$locationfilter' and audit='$selected_auditfilter' and category='$selected_filter'";
      }
